## ETF Analyzer / Passive Investing

This pplication is a financial database and web application, used with SQL, Python, and the Voilà library to analyze the performance of a fintech ETF.

What's Passive investing, you ask?  It means that you invest in a basket of assets that’s called an exchange-traded fund (ETF). As a result, the user won’t spend their time researching individual stocks or companies or take the risk of investing in a single stock. ETFs offer more diversification!
...
Clone local Repo: git clone https://github.com/Alexisg324/Passive_Investing.git
...
License
License license() A. HISTORY OF THE SOFTWARE ==========================
